 ...
 */
public class TestBehar extends TestCase{

	
    public TestBehar(String name){
        super(name);
    }

    
    public void testBehar2() throws Exception{

    	String INPUT = "/ISROOT/aisconvert/GSE21478-GPL8887_series_matrix-1.txt";
